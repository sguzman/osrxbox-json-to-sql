...
class Item:
    ...
    def data(self):
        return [
            ...
            self.buy_limit,
            self.quest_item,
            None if self.release_date is None else datetime.datetime.strptime(self.release_date, '%Y-%m-%d'),
            self.duplicate,
            self.examine,
            self.icon,
            self.wiki_name,
